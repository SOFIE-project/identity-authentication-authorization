...
async function readToken(body) {

    const data = parse(body);
    const owner = await contractInstance.methods.ownerOf(data.id).call();
    const metadata = await contractInstance.methods.getTokenURI(data.id).call();
    console.log('The owner of the token with id: ' + data.id + ' is: ' + owner + ' and the metadata of token: ' + metadata);
